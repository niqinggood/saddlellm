...
def UnslotSFTTrainer(MODEL_PATH,DATASET_PATH,OUTPUT_PATH,max_seq_length  = 2048,random_state=3407):
    import os
        ...
        def on_step_end(self, args, state, control, model=None, **kwargs):
            ...
            if state.global_step % 10 == 0:
                if torch.cuda.is_available():
                    ...
                    print(f"GPU Memory: Allocated {mem_allocated:.2f} GB, Cached {mem_cached:.2f} GB")
    # 加载模型和tokenizer
...
if __name__ == '__main__':
    ...
    UnslotSFTTrainer( MODEL_PATH = r'E:\reactflow_test\backend\model\lora_model_2423_step_120',
