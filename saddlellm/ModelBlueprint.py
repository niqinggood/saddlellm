...
class ModelBlueprint:
    ...
    def build_multimodal_model(self, image_token_id: Optional[int] = None):
        ...
        from .MultimodalProjector import MultimodalProjectorConfig
        from .MultimodalModeling import MultimodalForCausalLM
        from .VisionBackbones import VisionBackboneConfig
