...
distributed templates, orchestrator configs, and pretrain reports.
"""
import json
import os
...
class PretrainExperimentRunner:
    ...
    def build_bundle(self) -> ExperimentBundle:
        from .DataStrategy import DataMixPlanner
        from .DistributedConfig import DistributedConfig
        from .PretrainEvalSuite import PretrainEvalSuite
        ...
        for idx, plan in enumerate(plans):
            ...
            cfg = plan.to_orchestrator_config(
            ...
            config_path = self._save_json(os.path.join(run_dir, "orchestrator_config.json"), cfg)
